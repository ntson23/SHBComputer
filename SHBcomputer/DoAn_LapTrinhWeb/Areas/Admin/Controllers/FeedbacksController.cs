            ...
            if (User.Identity.IsAuthenticated)
            {
                if (User.Identity.Permiss_Update() == true || User.Identity.Permiss_Modify() == true)
                {
                    ...
                    if (feedback != null)
                    {
                        ...
                        string FeebackProduct = "<tr style='border-bottom: 1px solid rgba(0,0,0,.05);' class='product_item'>" +
                                              "<td valign='middle' width ='80%' style='text-align:left; padding:0 2.5em;'> " +
                                                  "<div class='product-entry'>" +
                                                      "<img src='https://SHBcomputer.tech/" + feedback.Product.image + "' style = 'width: 100px; max-width: 600px; height: auto; padding-bottom:5px; display: block;'>" +
                                                      "<div class='text'>" +
                        ...
                        { star = "<img src='https://res.cloudinary.com/binhnc/image/upload/v1688269426/images/star.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688270567/images/star-o.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688270567/images/star-o.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688270567/images/star-o.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688270567/images/star-o.png'> "; }
                        else if (feedback.rate_star == 2)
                        { star = "<img src='https://res.cloudinary.com/binhnc/image/upload/v1688269426/images/star.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688269426/images/star.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688270567/images/star-o.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688270567/images/star-o.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688270567/images/star-o.png'>"; }
                        else if (feedback.rate_star == 3)
                        { star = "<img src='https://res.cloudinary.com/binhnc/image/upload/v1688269426/images/star.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688269426/images/star.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688269426/images/star.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688270567/images/star-o.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688270567/images/star-o.png'>"; }
                        else if (feedback.rate_star == 4)
                        { star = "<img src='https://res.cloudinary.com/binhnc/image/upload/v1688269426/images/star.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688269426/images/star.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688269426/images/star.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688269426/images/star.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688270567/images/star-o.png'>"; }
                        else
                        { RatingStar = "<img src='https://res.cloudinary.com/binhnc/image/upload/v1688269426/images/star.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688269426/images/star.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688269426/images/star.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688269426/images/star.png'> <img src='https://res.cloudinary.com/binhnc/image/upload/v1688269426/images/star.png'>"; }
                        RatingStar = star;
